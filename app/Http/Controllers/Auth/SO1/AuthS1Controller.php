...
namespace App\Http\Controllers\Auth\SO1;
...
class AuthS1Controller extends Controller
{
    ...
    public function register(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        $validator = Validator::make($input, [
            'username' => 'required|regex:/(^([a-zA-z ]+)(\d+)?$)/u|min:5',
    ...
    public function github(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        try {
            ...
            if (!$user) {
                $user = new User();
                $user->username = isset($data->username) ? $data->username : $data->login;
                $user->email = $em;
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->only('username', 'provider_id', 'avatar', 'old_password', 'password', 'password_confirmation', 'fcm_token'), [
            'username' => 'sometimes|regex:/(^([a-zA-z ]+)(\d+)?$)/u|min:5',
        ...
        try {
            if (auth()->user()->id == $id) {
                $user->update($request->only('username', 'password', 'provider_id', 'avatar', 'fcm_token'));
                return response()->json([
                    'data' => $user
                ], 201);
            }
